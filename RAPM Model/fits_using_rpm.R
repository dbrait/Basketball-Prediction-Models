...
logit_accuracy <- 1 - sum(logit_preds$result)/length(ytest)
logit_accuracy
...
linear_accuracy <- 1 - sum(linear_preds$result)/length(ytest)
linear_accuracy
...
rf_accuracy <- 1 - sum(rf_preds$result)/length(ytest)
rf_accuracy