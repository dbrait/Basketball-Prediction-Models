...
#Read in player movement data for specific play for game
url = "http://stats.nba.com/stats/locations_getmoments/?eventid=308&gameid=0041400235"
x <- getURL(url)
the.data <- fromJSON(x)

#read full court image and rasterize it
...
#add quarter, game clock and shot clock info to each moment
